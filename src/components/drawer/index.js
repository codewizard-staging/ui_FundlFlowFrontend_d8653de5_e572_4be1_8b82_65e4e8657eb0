            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/investors")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Investors">
                                    <Tab />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Investors" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        <ListItemButton onClick={() => NavigateTo("/rounds/list")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="FundingRounds">
                                    <ShoppingBasket />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="FundingRounds" sx={{ pl: 1 }} />}
                        </ListItemButton>
